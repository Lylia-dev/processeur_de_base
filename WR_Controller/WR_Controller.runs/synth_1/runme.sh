...
HD_PWD='C:/Users/HP/Desktop/up/WR_Controller/WR_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WR_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WR_Controller.tcl
