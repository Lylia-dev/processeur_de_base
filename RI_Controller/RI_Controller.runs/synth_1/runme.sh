...
HD_PWD='C:/Users/HP/Desktop/up/RI_Controller/RI_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ri_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ri_controller.tcl
