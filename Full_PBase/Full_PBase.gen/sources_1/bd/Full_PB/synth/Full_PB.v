...
//Command     : generate_target Full_PB.bd
//Design      : Full_PB
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Full_PB,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Full_PB,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=18,numReposBlks=18,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_board_cnt=6,da_clkrst_cnt=3,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Full_PB.hwdef" *) 
module Full_PB
   (INPR_0,
    OUTR_0,
    clk_100MHz,
  ...
  input [7:0]INPR_0;
  output [7:0]OUTR_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_100MHZ CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_100MHZ, CLK_DOMAIN Full_PB_clk_100MHz, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_100MHz;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_100MHZ_1 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_100MHZ_1, CLK_DOMAIN Full_PB_clk_100MHz_1, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_100MHz_1;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_100MHZ_2 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_100MHZ_2, CLK_DOMAIN Full_PB_clk_100MHz_2, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_100MHz_2;
  ...
  Full_PB_ALU_Controller_0_0 ALU_Controller_0
       (.AC(ALU_Controller_0_AC),
        ...
        .clk(Net));
  Full_PB_Control_Unit_0_0 Control_Unit_0
       (.F(F_controller_0_F),
        ...
        .S(S_Controller_0_S),
        .clk(Net));
  Full_PB_E_controller_0_0 E_controller_0
       (.E(E_controller_0_E),
  ...
  Full_PB_FGI_Controller_0_0 FGI_Controller_0
       (.F43(Control_Unit_0_F43),
        .FGI(FGI_Controller_0_FGI),
        .clk(Net));
  Full_PB_FGO_Controller_0_0 FGO_Controller_0
       (.F44(Control_Unit_0_F44),
        .FGO(FGO_Controller_0_FGO),
        .clk(Net));
  Full_PB_F_controller_0_0 F_controller_0
       (.F(F_controller_0_F),
        .F13(Control_Unit_0_F13),
        .F5(Control_Unit_0_F5),
        .F9(Control_Unit_0_F9),
        .clk(Net1));
  Full_PB_MDR_Controller_0_0 MDR_Controller_0
       (.AC(ALU_Controller_0_AC),
        ...
        .MDR(MDR_Controller_0_MDR),
        .clk(Net));
  Full_PB_RAM_4Kx16_0_1 RAM_4Kx16_0
  ...
  Full_PB_R_Controller_0_1 R_Controller_0
       (.F4(Control_Unit_0_F4),
        .F9(Control_Unit_0_F9),
        .R(R_Controller_0_R),
        .clk(Net1));
  Full_PB_S_Controller_0_0 S_Controller_0
       (.F42(Control_Unit_0_F42),
        .S(S_Controller_0_S),
        .clk(Net1));
  Full_PB_WR_Controller_0_0 WR_Controller_0
       (.F11(Control_Unit_0_F11),
        .F15(Control_Unit_0_F15),
        .F18(Control_Unit_0_F18),
        .F2(Control_Unit_0_F2),
        ...
        .R(WR_Controller_0_R),
        .W(WR_Controller_0_W));
  Full_PB_clk_wiz_0 clk_wiz
       (.clk_in1(\^clk_100MHz_1 ),
        .clk_out1(Net),
        .reset(reset_rtl_0_1));
  Full_PB_clk_wiz_1_0 clk_wiz_1
       (.clk_in1(clk_100MHz_1_1),
        .clk_out1(clk_wiz_1_clk_out1),
        .reset(\^reset_rtl_0_0_1 ));
  Full_PB_clk_wiz_2_0 clk_wiz_2
       (.clk_in1(clk_100MHz_2_1),
        .clk_out1(Net1),
        .reset(reset_rtl_0_0_1_1));
  Full_PB_mar_controller_0_0 mar_controller_0
       (.F1(Control_Unit_0_F1),
        .F10(Control_Unit_0_F10),
        .F14(Control_Unit_0_F14),
        .F17(Control_Unit_0_F17),
        ...
        .RI(ri_controller_0_RI),
        .clk(Net));
  Full_PB_outr_controller_0_0 outr_controller_0
       (.AC(ALU_Controller_0_AC),
        .F43(Control_Unit_0_F43),
        .OUTR(outr_controller_0_OUTR),
        .clk(Net));
  Full_PB_pc_controller_0_0 pc_controller_0
       (.AC(ALU_Controller_0_AC),
        .E(E_controller_0_E),
        .F2(Control_Unit_0_F2),
        .F23(Control_Unit_0_F23),
        ...
        .PC(pc_controller_0_PC),
        .clk(Net1));
  Full_PB_ri_controller_0_0 ri_controller_0
       (.F3(Control_Unit_0_F3),
        .MDR(MDR_Controller_0_MDR),
        .RI(ri_controller_0_RI),
        .clk(Net));
