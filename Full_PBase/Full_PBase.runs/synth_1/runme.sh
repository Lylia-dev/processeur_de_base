...
HD_PWD='C:/Users/HP/Desktop/up/Full_PBase/Full_PBase.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_PB_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Full_PB_wrapper.tcl
