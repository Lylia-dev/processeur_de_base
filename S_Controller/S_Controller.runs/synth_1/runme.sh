...
HD_PWD='C:/Users/HP/Desktop/up/S_Controller/S_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S_Controller.tcl
