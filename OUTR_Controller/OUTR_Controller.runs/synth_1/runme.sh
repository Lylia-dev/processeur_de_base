...
HD_PWD='C:/Users/HP/Desktop/up/OUTR_Controller/OUTR_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log outr_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source outr_controller.tcl
