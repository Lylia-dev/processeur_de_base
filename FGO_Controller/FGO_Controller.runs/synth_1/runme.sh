...
HD_PWD='C:/Users/HP/Desktop/up/FGO_Controller/FGO_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FGO_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FGO_Controller.tcl
