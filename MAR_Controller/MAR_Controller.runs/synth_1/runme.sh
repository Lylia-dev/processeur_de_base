...
HD_PWD='C:/Users/HP/Desktop/up/MAR_Controller/MAR_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mar_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mar_controller.tcl
