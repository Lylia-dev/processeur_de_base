...
HD_PWD='C:/Users/HP/Desktop/up/R_Controller/R_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log R_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source R_Controller.tcl
