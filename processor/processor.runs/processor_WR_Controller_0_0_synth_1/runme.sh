...
HD_PWD='C:/Users/HP/Desktop/up/processor/processor.runs/processor_WR_Controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_WR_Controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processor_WR_Controller_0_0.tcl
