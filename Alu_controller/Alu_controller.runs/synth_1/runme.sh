...
HD_PWD='C:/Users/HP/Desktop/up/Alu_controller/Alu_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_Controller.tcl
