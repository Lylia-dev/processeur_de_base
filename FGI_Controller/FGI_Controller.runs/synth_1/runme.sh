...
HD_PWD='C:/Users/HP/Desktop/up/FGI_Controller/FGI_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FGI_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FGI_Controller.tcl
