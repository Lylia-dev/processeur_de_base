...
HD_PWD='C:/Users/HP/Desktop/up/E_Controller/E_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log E_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source E_controller.tcl
