...
HD_PWD='C:/Users/HP/Desktop/up/MDR_Controller/MDR_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MDR_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MDR_Controller.tcl
