...
HD_PWD='C:/Users/HP/Desktop/up/PC_controller/PC_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pc_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pc_controller.tcl
